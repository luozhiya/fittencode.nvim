...
local CharCode = {
    Null = 0,                                                    -- NULL
    Backspace = 8,                                               -- The `\b` character.
    Tab = 9,                                                     -- The `\t` character.
    LineFeed = 10,                                               -- The `\n` character.
    CarriageReturn = 13,                                         -- The `\r` character.
    Space = 32,                                                  -- Space
    ExclamationMark = 33,                                        -- The `!` character.
    DoubleQuote = 34,                                            -- The `"` character.
    Hash = 35,                                                   -- The `#` character.
    DollarSign = 36,                                             -- The `$` character.
    PercentSign = 37,                                            -- The `%` character.
    Ampersand = 38,                                              -- The `&` character.
    SingleQuote = 39,                                            -- The `'` character.
    OpenParen = 40,                                              -- The `(` character.
    CloseParen = 41,                                             -- The `)` character.
    Asterisk = 42,                                               -- The `*` character.
    Plus = 43,                                                   -- The `+` character.
    Comma = 44,                                                  -- The `,` character.
    Dash = 45,                                                   -- The `-` character.
    Period = 46,                                                 -- The `.` character.
    ...
    Colon = 58,                                                  -- The `:` character.
    Semicolon = 59,                                              -- The `;` character.
    LessThan = 60,                                               -- The `<` character.
    Equals = 61,                                                 -- The `=` character.
    GreaterThan = 62,                                            -- The `>` character.
    QuestionMark = 63,                                           -- The `?` character.
    AtSign = 64,                                                 -- The `@` character.
    ...
    OpenSquareBracket = 91,                                      -- The `[` character.
    Backslash = 92,                                              -- The `\` character.
    CloseSquareBracket = 93,                                     -- The `]` character.
    Caret = 94,                                                  -- The `^` character.
    Underline = 95,                                              -- The `_` character.
    BackTick = 96,                                               -- The ``(`)`` character.
    ...
    OpenCurlyBrace = 123,                                        -- The `{` character.
    Pipe = 124,                                                  -- The `|` character.
    CloseCurlyBrace = 125,                                       -- The `}` character.
    Tilde = 126,                                                 -- The `~` character.

    NoBreakSpace = 160,                                          -- The &nbsp; (no-break space) character. Unicode Character 'NO-BREAK SPACE' (U+00A0)
    ...
    LINE_SEPARATOR = 0x2028,                                     -- Unicode Character 'LINE SEPARATOR' (U+2028)
    PARAGRAPH_SEPARATOR = 0x2029,                                -- Unicode Character 'PARAGRAPH SEPARATOR' (U+2029)
    NEXT_LINE = 0x0085,                                          -- Unicode Character 'NEXT LINE' (U+0085)
    ...
    U_MODIFIER_LETTER_MIDDLE_DOUBLE_GRAVE_ACCENT = 0x02F5,       -- U+035A	MODIFIER LETTER MIDDLE DOUBLE GRAVE ACCENT
    ...
    UTF8_BOM = 65279,                                            -- UTF-8 BOM Unicode Character 'ZERO WIDTH NO-BREAK SPACE' (U+FEFF)
