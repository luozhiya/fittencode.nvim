...
---@class FittenCode.Unicode.EncodedStringLayout
---@field cumulative_units table<integer>
...
-- pos/start/end
---@param s string
---@return FittenCode.Unicode.EncodedStringLayout
function M.utf8_layout(s)
    local byte_counts = {}
    local utf8_starts = {}
    local utf8_ends = {}
    ...
    while position <= length do
        ...
        table.insert(utf8_starts, position)
        table.insert(utf8_ends, position + byte_count - 1)
...
---@param s string
---@return FittenCode.Unicode.EncodedStringLayout
function M.utf16_layout(s)
    local cumulative_units = {}
    local utf8_starts = {}
    local utf8_ends = {}
    ...
    while position <= length do
        local first_byte = string.byte(s, position)
        local utf8_byte_count = M.utf8_bytes(first_byte)

        local is_supplementary = utf8_byte_count == 4
        local utf16_units = is_supplementary and 2 or 1

        cumulative_units[char_index] = utf16_units + (cumulative_units[char_index - 1] or 0)
        utf8_starts[char_index] = position
        utf8_ends[char_index] = position + utf8_byte_count - 1

        position = position + utf8_byte_count
...
---@class FittenCode.Unicode.MultiEncodingStringLayout
...
function M.multi_encoding_layout(s)
    ...
    while position <= length do
        ...
        u8_byte_count = M.utf8_bytes(first_byte)
...
--]]
---@param layout FittenCode.Unicode.MultiEncodingStringLayout
---@param encoding lsp.PositionEncodingKind
---@param index? integer
---@return integer, integer?
function M.utf_to_byteindex_by_layout(layout, encoding, index)
...
---@param index? integer
---@return integer
function M.byte_to_utfindex_by_layout(layout, encoding, index)
    local utf8_starts = layout.utf8_starts
    local utf8_ends = layout.utf8_ends
    local cumulative_units = layout.cumulative_units[encoding]
...
---@param index? integer
---@return integer
function M.round_start_by_layout(layout, encoding, index)
    local utf8_starts = layout.utf8_starts
    local utf8_ends = layout.utf8_ends
    local cumulative_units = layout.cumulative_units[encoding]
...
---@param index? integer
---@return integer
function M.round_end_by_layout(layout, encoding, index)
    local utf8_starts = layout.utf8_starts
    local utf8_ends = layout.utf8_ends
    local cumulative_units = layout.cumulative_units[encoding]
